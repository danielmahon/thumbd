var exec = require('child_process').exec,
	...
	gm = graphicsMagick.subClass({ imageMagick: true }),
...
/**
* Convert the pdf to an animated gif
* convert -verbose -delay 250 -loop 0 -density 300 -resize x128 ./WhyPadblasterTTS_FINAL_PRINT.pdf pdf.gif
*/
Thumbnailer.prototype.pdf = function() {
	var dimensionsString = (this.width || '') + 'x' + (this.height || ''),
	qualityString = (this.quality ? '-quality ' + this.quality : ''),
	thumbnailCommand = config.get('convertCommand') + ' -delay 250 -loop 0 -density 72 -resize ' + dimensionsString + qualityString + ' ' + this.localPaths[0] + ' ' + this.convertedPath;
